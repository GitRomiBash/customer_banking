...
def main():
    ...
    savings_months = int(input("What is your savings maturity? "))
    ...
    cd_months = int(input("What is your months amount? "))

    # Call the create_cd_account function and pass the variables from the user.
    updated_cd_balance, interest_earned = create_cd_account(cd_balance, cd_interest, cd_months)

    # Print out the interest earned and updated CD account balance with interest earned for the given months.
    print(f"Interest Earned for CD account: {interest_earned:.2f}, Updated Balance: {updated_cd_balance:.2f}")
    # ADD YOUR CODE HERE
